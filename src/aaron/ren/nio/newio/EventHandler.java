...
public class EventHandler implements Handler{
    ...
    @Override
    public void handle(SelectionKey sk) throws IOException, InterruptedException {
        if (sk.isReadable()) {
     ...
     * @param content
     */
    private void process(String content) throws IOException, InterruptedException {
        System.out.println("[receive from client] -> client:" + socketChannel.getRemoteAddress() + ", content: " + content);
        System.out.println("=============假设服务端处理数据很好四=======================");
        //Thread.sleep(60000);
